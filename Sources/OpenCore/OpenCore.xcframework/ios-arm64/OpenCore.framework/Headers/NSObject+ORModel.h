...
@interface NSObject (ORModel)

+ (NSDictionary *)or_dictionaryWithJSON:(id)json;
 ...
 */
+ (nullable instancetype)or_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)or_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)or_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)or_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)or_modelToJSONObject;
 ...
 */
- (nullable NSData *)or_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)or_modelToJSONString;
 ...
 */
- (void)or_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)or_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
+ (nullable NSArray *)or_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (ORModel)
 ...
 */
+ (nullable NSDictionary *)or_modelDictionaryWithClass:(Class)cls json:(id)json;
@end

@protocol ORModel <NSObject>
@optional
